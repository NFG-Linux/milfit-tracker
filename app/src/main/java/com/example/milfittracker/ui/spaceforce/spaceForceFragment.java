...
public class spaceForceFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        vm.getAllLive().observe(getViewLifecycleOwner(), list -> {
            Scores latest = latestForBranch(list, "Space Force");
            if (latest != null) {
        ...
        btnMock.setOnClickListener(vw -> {
            ...
            navController.navigate(R.id.spaceforce_to_stopwatch);
        });
    ...
    private void showGoalDialog() {
        ...
        new AlertDialog.Builder(requireContext())
                ...
                .setPositiveButton("Save", (d, w) -> {
                    ...
                    SetGoal goal = new SetGoal("Space Force", event, val, unit, selectedDate[0]);
